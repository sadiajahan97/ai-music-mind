  ...
  return (
    <div className="flex flex-col min-h-screen bg-bg-dark">
      ...
      <main className="flex-1 overflow-y-auto scroll-hide pb-24">
        <section className="flex flex-col items-center px-4 py-8 bg-gradient-to-b from-primary/12 to-transparent">
          <div className="relative mb-4">
            <div className="w-20 h-20 rounded-full bg-gradient-to-tr from-primary to-pink-500 flex items-center justify-center text-3xl font-bold text-white"
              style={{ fontFamily: "var(--font-display), Syne, sans-serif" }}
            >
              JP
            </div>
            <div className="absolute bottom-0 right-0 w-7 h-7 rounded-full bg-primary border-2 border-bg-dark flex items-center justify-center">
              <Icon name="edit" className="text-white" style={{ fontSize: 14 }} />
            </div>
          </div>
          <h2
          ...
          <p className="text-slate-400 text-sm mt-1">@julianp · Creator since 2024</p>
        ...
        <div className="px-4 space-y-5 py-2">
          <div>
            ...
            <div className="space-y-2">
              {[
                ...
                { icon: "diamond", label: "Pro Subscription", sub: "Active · $12/mo" },
                ...
                >
                  ...
                  <Icon name="chevron_right" className="text-slate-500" style={{ fontSize: 18 }} />
                </div>
              ))}
            </div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-2">
              <div className="glass-card p-4 rounded-xl flex items-center justify-between">
                <div className="flex items-center gap-3">
                  <Icon name="audio_file" className="text-primary" style={{ fontSize: 20 }} />
              ...
              <div className="glass-card p-4 rounded-xl flex items-center justify-between">
                <div className="flex items-center gap-3">
                  <Icon name="mic" className="text-primary" style={{ fontSize: 20 }} />
          ...
          <div>
            ...
            <div className="space-y-2">
              <div className="glass-card p-4 rounded-xl flex items-center justify-between">
                <div className="flex items-center gap-3">
                  <Icon name="dark_mode" className="text-primary" style={{ fontSize: 20 }} />
              ...
              <div className="glass-card p-4 rounded-xl flex items-center justify-between">
                <div className="flex items-center gap-3">
                  <Icon name="notifications" className="text-primary" style={{ fontSize: 20 }} />
